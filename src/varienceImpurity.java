...
class treeNodes1{
	...
	void calculateGain(){
		...
		if(leftSide==null && rightSide==null){
			...
			informationGain=(float)e-(ent2+ent3);
...
public static void main(String[] args) throws IOException{
	...
	double accuracy=(double) Math.round(tree.accuracy(testingSet)*10000)/100;  //correction
	System.out.println("Accuracy pre pruning="+accuracy+"%");
	...
	System.out.println("Accuracy post pruning ="+accuracy+"%");
